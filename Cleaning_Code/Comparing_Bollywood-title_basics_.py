##### This is third step where we compare both the Bollywood title in wikipedia and IMDB data
...
for year in range(2000, 2026):
    ...
    movie_path = fr'D:\Movie Analytics\Wikipedia_Bollywood_movie\Wikipedia_Bollywood_movie_cleaned\movie_table_{year}_filtered.tsv'
...
if all_data:
    ...
    output_path = r'D:\Movie Analytics\IMDB_data\Cleaned_data\Bollywood_matched_data.tsv'
